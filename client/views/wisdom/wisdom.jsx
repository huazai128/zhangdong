...
class Function extends React.Component {
	...
	render() {
		return <div id="function">
			...
			{/* 内容 */}
			<NavsBox cls="service" title="无线通信模组测试" datas={['通过无线通信模组测试产品的性能，包括发射性能、接收性能、电源适应性、传输性能等专业测试。']} />
			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><img className='imgHang' src={require('img/zhideng1.png')} alt="" /></li>
						<li><img className='imgHang' src={require('img/zhideng2.jpg')} alt="" /></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
