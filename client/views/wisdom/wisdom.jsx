			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><a href="javascript:void(0);"><img className='imgHang' src={require('img/zhideng1.png')} alt="" /></a></li>
						<li><a href="javascript:void(0);"><img className='imgHang' src={require('img/zhideng2.jpg')} alt="" /></a></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
