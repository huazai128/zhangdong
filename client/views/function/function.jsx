...
class Function extends React.Component {
	...
	render() {
		return <div id="function">
			...
			{/* 内容 */}
			<NavsBox cls="service" title="功能测试" datas={['专家分析走查+自动化功能测试', '测试团队通过专家结合工具的测试方法进行功能测试服务']} />
			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><img src={require('img/wei1.jpg')} alt="" /></li>
						<li><img src={require('img/wei2.jpg')} alt="" /></li>
						<li><img src={require('img/wei3.jpg')} alt="" /></li>
						<li><img src={require('img/wei4.jpg')} alt="" /></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
