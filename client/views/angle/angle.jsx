              ...
              <div className="contentcar">
                 ...
                 <div className='blue'></div>
                  ...
                  <ul className='flex-hcenter'>
                      <li><a href="#"><img src={require("img/angle1.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/angle2.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/angle3.jpg")} alt=""/></a></li>
                 ...
                 <div className='blue'></div>
                  ...
                  <p className='flex'>测试手机端不足，需要一个专业的测试团队对硬件与软件进行测试。 
                  </p>
                  <div className='flex-vcenter' style={{height:70}}>
                 <div className='blue'></div>
                  <h5 className="">解决方案</h5>
                 </div>
                  <p className='flex'>采用专家走查的方式，进行用户体验测试，目的是站在用户角度思考解决方案，提高智能净水器这一产品的用户体验，改善产品，提高产品的竞争力。此外，还将进行深度兼容测试和蓝牙<br></br>
                  兼容配对测试，检测产品与市场主流手机之间的蓝牙兼容性及通信稳定性。
                  </p>
