...
class Function extends React.Component {
	...
	render() {
		return <div id="function">
			...
			{/* 内容 */}
			<NavsBox cls="service" title="连通性测试" datas={['（测试产品网络状况、硬件跟手机节点之间打流，误码率、传输速率、延时等测试）']} />
			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><img src={require('img/angle1.jpg')} alt="" /></li>
						<li><img src={require('img/angle2.jpg')} alt="" /></li>
						<li className='flex-vcenter'><img src={require('img/angle3.jpg')} alt="" /></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
