            ...
            <div className='content'>
               ...
               <div className="contentcar">
                 ...
                 <div className='blue'></div>
                  ...
                  <p className='flex'>
                  贯彻中国移动集团公司战略转型的要求，向用户提供优质的产品体验，由互联网基地承建面向全网的“移动互联网应用用户体验测评共享中心”，向全集团各产品线提供专业化、多样化的体验测评能力支撑。
                  </p>
                  <p>企业想建立一个专业的团队。
                  </p>
                  <ul className='flex-hcenter'>
                      <li><a href="#"><img src={require("img/yidong1.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/yidong2.png")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/yidong3.png")} alt=""/></a></li>
                      {/* <li><a href="#"><img src={require("img/yidong4.png")} alt=""/></a></li> */}
                  </ul>
                  <div className='flex-vcenter' style={{height:70}}>
                 <div className='blue'></div>
