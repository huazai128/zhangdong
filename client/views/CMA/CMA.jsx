              ...
              <div className="contentcar">
                 ...
                 <div className='blue'></div>
                  ...
                  <ul className='flex-hcenter'>
                      <li><a href="#"><img src={require("img/wangyi163.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/wangyi163.jpg")} alt=""/></a></li>
                 ...
                 <div className='blue'></div>
                  ...
                  <p className='flex'>处于验收建设关键阶段需要申请政府科技计划项目资助、申报各类科技成果奖，以及软件产品入市的准备，需要反映成果的技术水平和市场价值。 
                  </p>
                  <div className='flex-vcenter' style={{height:70}}>
                 <div className='blue'></div>
                  <h5 className="">解决方案</h5>
                 </div>
                  <p className='flex'>根据专项资金拨款项目和科研项目计划任务书的要求，对软件产品所应实现的功能和性能指标进行验证，为承担过政府资助项目的IT企业提供国家工信部权威的第三方测试
                  </p>
