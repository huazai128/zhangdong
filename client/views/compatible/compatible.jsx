...
class Function extends React.Component {
	...
	render() {
		return <div id="function">
			...
			{/* 内容 */}
			<NavsBox cls="service" title="兼容测试" datas={['上千款测试真机设备供客户挑选，完善自动化测试系统，快速定位，解决问题。']} />
			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><img src={require('img/图1.jpg')} alt="" /></li>
						<li><img src={require('img/图2.jpg')} alt="" /></li>
						<li><img src={require('img/图3.jpg')} alt="" /></li>
						<li><img src={require('img/图4.jpg')} alt="" /></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
