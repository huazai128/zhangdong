			...
			<div className={`${this.props.bgCls} topBox`}>
				<div className="content">
					...
					<div className="bottomContent">
						{this.props.bgCls === 'solve' || this.props.bgCls === 'main' || this.props.bgCls === 'new' || this.props.bgCls === 'our' || this.props.bgCls === 'app' || this.props.bgCls === 'hardware' || this.props.bgCls === 'education' || this.props.bgCls === 'lab'|| this.props.bgCls === 'newDetail' ? null : <p className='pTow'>立即申请</p>}
					</div>
					<div className="count">
