...
class Function extends React.Component {
	...
	render() {
		return <div id="function">
			...
			<NavsBox cls="service" title="性能测试" datas={['基于业务场景与用户行为的全链路压力测试，发现并发瓶颈，优化容量规划']} />
			...
			<div className="contentcar">
				<div className='box'>
					...
					<ul className='flex-hcenter'>
						<li><img src={require('img/property1.jpg')} alt="" /></li>
						<li><img src={require('img/property2.jpg')} alt="" /></li>
						<li><img src={require('img/property3.jpg')} alt="" /></li>
					</ul>
					<div className='flex-vcenter' style={{ height: 46 }}>
						<div className='blue'></div>
