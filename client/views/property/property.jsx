              ...
              <div className="contentcar">
                ...
                能终端等新一代互联网技术，建成省级食品药品监管数据中心统一信息网络。</p>
                  <ul className='flex-hcenter'>
                      <li><a href="#"><img src={require("img/property1.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/property2.jpg")} alt=""/></a></li>
                      <li><a href="#"><img src={require("img/property3.jpg")} alt=""/></a></li>
